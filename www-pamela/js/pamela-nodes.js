...
NorbertNode.prototype.draw = function() {
	...
	var x = Math.floor(this.projection.x - (200 / s));
	var y = Math.floor(this.projection.y - (140 / s));
	//var x = Math.floor(this.projection.x - (80 / s));
	//var y = Math.floor(this.projection.y - (80 / s));
